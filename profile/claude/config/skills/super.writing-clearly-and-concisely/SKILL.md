---
name: super.writing-clearly-and-concisely
...
2. Dispatch a subagent with your draft and `elements-of-style.md` (set an explicit `model:` — copyedit is light, so floor it at `cheap`/`standard`; never inherit the controller's model)
